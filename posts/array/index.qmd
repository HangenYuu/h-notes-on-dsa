...
-   Space complexity: <!-- Add your space complexity here, e.g. $$O(n)$$ --> $O(n)$: In the worst case, we will have a dictionary with a size equal to the array.
...
-   Space complexity: <!-- Add your space complexity here, e.g. $$O(n)$$ --> $O(n)$: In the worst case, we will have a set with a size equal to the array.
...
-   Time complexity: <!-- Add your time complexity here, e.g. $$O(n)$$ --> $O(n)$: We need to traverse the array once.
-   Space complexity: <!-- Add your space complexity here, e.g. $$O(n)$$ --> $O(1)$: We only need to keep track of the count and the candidate, which requires constant memory.
...
-   Time complexity: <!-- Add your time complexity here, e.g. $$O(n)$$ --> $O(nk)$: We need to traverse the array once. $k$ is the maximum length of a string in the array.
...
-   Time complexity: <!-- Add your time complexity here, e.g. $$O(n)$$ --> $O(n)$: We need to traverse the array once and the dictionary once. Worst-case, the dictionary has the same size as the array.
-   Space complexity: <!-- Add your space complexity here, e.g. $$O(n)$$ --> $O(n)$: Worst-case, we will need to store triple the memory of the original array.
...
- Time complexity: <!-- Add your time complexity here, e.g. $$O(n)$$ --> $O(n)$: We need to traverse the array and string once for each.
- Space complexity: <!-- Add your space complexity here, e.g. $$O(n)$$ --> $O(1)$: We will need to store some pointers for both functions.
...
- Time complexity: <!-- Add your time complexity here, e.g. $$O(n)$$ --> $O(n)$: We need to traverse the original array twice.
- Space complexity: <!-- Add your space complexity here, e.g. $$O(n)$$ --> $O(1)$: We will need to store the postfix product while calculating.
...
- Time complexity: <!-- Add your time complexity here, e.g. $$O(n)$$ --> $O(n^2)$: We need to traverse the original array with a nested for loop. Of course, if we are dealing with a standard Sudoku every time then it is $O(1)$.
- Space complexity: <!-- Add your space complexity here, e.g. $$O(n)$$ --> $O(n)$: We will need to store 3 dictionaries with worse case the same size as the board.
...
- Time complexity: <!-- Add your time complexity here, e.g. $$O(n)$$ --> $O(n)$: We need to traverse the original array once
- Space complexity: <!-- Add your space complexity here, e.g. $$O(n)$$ --> $O(n)$: We will need to store a set with the same size as the array.
