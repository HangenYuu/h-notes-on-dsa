...
There can be a follow-up question: "What if the input array does not necessarily contain only distinct elements?" For this question, the decision to be made becomes whether to include one or more instances of a number or not.
